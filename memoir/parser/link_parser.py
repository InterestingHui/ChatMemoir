...
def parser_record_item(recorditem, output_dir, uid, msg_time, level=0):
        ...
        if type_ == '1':
            ...
            result.append(
                MergedMessage(
                    ...
                    messages=parser_record_item(item.get('recordxml'), output_dir, uid,
                                                msg_time, level + 1),
                    level=level
                )
            )
...
def parser_merged_messages(xml: str, output_dir, uid, msg_time, level=0):
    try:
        try:
