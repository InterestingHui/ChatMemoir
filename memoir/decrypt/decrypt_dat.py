...
def get_decode_code_v4(data_dir):
    """
    ...
    if not os.path.isdir(data_dir) or not os.path.exists(cache_dir):
        raise ValueError(f'微信路径输入错误，请检查：{data_dir}')
...
if __name__ == '__main__':
    data_dir = ''
    xor_key = get_decode_code_v4(data_dir)
