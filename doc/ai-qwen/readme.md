...
![GPU](/mind/img/img3.png)

# 开始训练
**可以参照训练[模板](/mind/qwen2-0.5b/train.md)**
<br>
把 `train.json` 上传,一步步点击即可<br>
最后把模型上传到 `Modelspace`
<br />
![训练](/mind/img/img4.png)
# 部署到创空间
编辑 `di_config.json` 的一下两个字段
`model_space: YOUR-NAME-SPACE` 
`model_name: YOUR-MODEL-NAME`

**然后把一下mind/qwen2-0.5b的三个文件:`di_config.json`,`app.py`,`requirements.txt`上传到创空间,点击部署！**
