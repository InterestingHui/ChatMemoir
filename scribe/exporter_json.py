...
from scribe.exporter_base import ExporterBase, remove_privacy_info, get_new_filename
...
class JsonExporter(ExporterBase):
    ...
    def split_by_time(self, length=300):
        ...
        @return:
        """
        messages = self.database.get_messages_by_type(self.contact.uid, type_=MessageType.Text,
